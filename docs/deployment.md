...
SangokGIS MVP는 정적 Vite 앱이므로 Vercel에 배포할 수 있습니다.
...
- CHGIS V6 원본 데이터는 재배포 제한이 있으므로 `data/raw/`에만 보관하고 배포 산출물에 넣지 않습니다.
- OpenStreetMap 타일을 사용하는 동안 지도 attribution을 제거하지 않습니다.
